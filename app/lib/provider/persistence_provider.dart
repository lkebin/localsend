...
const _androidBackgroundMode = 'ls_android_background_mode';
...
class PersistenceService {
  ...
  bool isAndroidBackgroundMode() {
    return _prefs.getBool(_androidBackgroundMode) ?? false;
  }

  Future<void> setAndroidBackgroundMode(bool enabled) async {
    await _prefs.setBool(_androidBackgroundMode, enabled);
  }
}
