...
class SettingsService extends PureNotifier<SettingsState> {
  ...
  SettingsState init() => SettingsState(
    ...
    androidBackgroundMode: _persistence.isAndroidBackgroundMode(),
  );
  ...
  Future<void> setAndroidBackgroundMode(bool enabled) async {
    await _persistence.setAndroidBackgroundMode(enabled);
    state = state.copyWith(androidBackgroundMode: enabled);
  }
}
